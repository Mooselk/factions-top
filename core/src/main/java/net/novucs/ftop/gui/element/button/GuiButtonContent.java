...
public class GuiButtonContent {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(text, that.text) && Objects.equals(lore, that.lore) && material == that.material;
	}
	...
	public String toString() {
		return "GuiButtonContent{" + "text='" + text + '\'' + ", lore=" + lore + ", material=" + material + '}';
	}
	...
	public static class Builder {
		...
		public boolean equals(Object o) {
			...
			return Objects.equals(text, builder.text) && Objects.equals(lore, builder.lore)
		...
		@Override
		public String toString() {
			return "Builder{" + "text='" + text + '\'' + ", lore=" + lore + ", material=" + material + '}';
		}
	}
}
